...
try:
    from .specialized_prompts import DATA_ANALYST_EXPERT_PROMPT
except ImportError:
    DATA_ANALYST_EXPERT_PROMPT = """You are an expert marketing data analyst. You analyze marketing datasets, 
...
class DataAnalystAgent(BaseAgent):
    ...
    def execute_task(self, task_description: str, **kwargs) -> Dict[str, Any]:
        ...
        system_prompt = DATA_ANALYST_EXPERT_PROMPT
