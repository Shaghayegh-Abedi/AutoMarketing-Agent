...
try:
    from .specialized_prompts import OUTREACH_EXPERT_PROMPT
except ImportError:
    OUTREACH_EXPERT_PROMPT = """You are an expert in outreach and relationship building. You craft personalized, 
...
class OutreachAgent(BaseAgent):
    ...
    def execute_task(self, task_description: str, recipient_type: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        ...
        system_prompt = OUTREACH_EXPERT_PROMPT
