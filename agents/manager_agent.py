...
# Import specialized prompts and communication bus
try:
    from .specialized_prompts import MANAGER_EXPERT_PROMPT
except ImportError:
    MANAGER_EXPERT_PROMPT = """You are an experienced marketing manager leading a team of specialists."""
...
class ManagerAgent:
    ...
    def __init__(self, context_manager: ContextManager, data_file: str = "data/marketing_data.csv"):
        ...
        # Initialize communication bus for agent-to-agent messaging
        self.communication_bus = None
        if COMMUNICATION_AVAILABLE:
            try:
                self.communication_bus = AgentCommunicationBus()
            except Exception as e:
                print(f"Warning: Communication bus not available: {e}")
    ...
    def create_plan(self, brief: str) -> Dict[str, Any]:
        ...
        system_prompt = MANAGER_EXPERT_PROMPT
        ...
        try:
            ...
            if similar_campaigns:
                similar_campaigns_info = "\n\nSimilar past campaigns to reference:\n"
